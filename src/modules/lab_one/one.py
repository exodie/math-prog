"""
1)	Определить абсолютную и относительную погрешности полученных
 приближенных чисел, округляя следующие числа до трех значащих чисел.
а)  0,16152;     b) 0,01204;     c) 1,225.
...
def one():
    ...
    for i in range(len(numbers)):
        ...
        print(f"Абсолютная погрешность: {errors[i][1]:.10f}")
